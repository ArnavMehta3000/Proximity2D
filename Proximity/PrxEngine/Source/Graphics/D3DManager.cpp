...
//
//		/*
//		* CREATE_ZERO(DXGI_SWAP_CHAIN_DESC1, swapChainDesc);
...
//		PRX_FAIL_HR(hr);
  // http://www.directxtutorial.com/Lesson.aspx?lessonid=112-4-2

		ComPtr<ID3D11Device> dev;
		ComPtr<ID3D11DeviceContext> con; D3D11CreateDevice(
			nullptr,
			D3D_DRIVER_TYPE_HARDWARE,
			nullptr,
			0,
